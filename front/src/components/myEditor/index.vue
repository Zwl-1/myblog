...
export default {
  ...
  props: {
    ...
    imgUploadUrl: {
      type: String,
      default: 'http://localhost:80/upload-image'
    }
  },
  setup (props, { emit }) {
    ...
    function imgUploadFn (blobInfo, success, failure) {
      ...
      // 图片上传
      const result = axios.post(props.imgUploadUrl, params, config).then(res => {
        // success('/public/uploads/1.jpg')
